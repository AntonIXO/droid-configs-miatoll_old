...
repo --name=sailfishos-crypt --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/sony:/tama:/aosp10/sailfish_latest_aarch64/
repo --name=sailfishos-chum --baseurl=https://repo.sailfishos.org/obs/sailfishos:/chum/@RELEASE@_@ARCH@/
